...
export class DishDetailComponent implements OnInit {
	...
	constructor(private _location: Location, private dishService: DishService,
		private router: Router, private store: Store<DishReducer.State>,
	...
	ngOnInit(): void {
		...
		this.dishCommentsWithAuthors$ = combineLatest([this.dish$, this.users$]).pipe(
			map(
				([dish, users]) => {
